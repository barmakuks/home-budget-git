#ifndef GET_TYPE_TRAITS_HPP
#define GET_TYPE_TRAITS_HPP
...
{
    static const bool value = std::is_base_of<std::map<typename T::key_type, typename T::mapped_type>, T>::value;
};
