...
void SetBalanceValue(BalanceRow& balance, const std::string& field, const std::string& value)
{
    std::string name = field;
    std::transform(name.begin(), name.end(), name.begin(), ::tolower);
...
void SetCurrencyValue(Currency& currency, const std::string& field, const std::string& value)
{
    std::string name = field;
    std::transform(name.begin(), name.end(), name.begin(), ::tolower);
...
void SetDocumentValue(Document& doc, const std::string& field, const std::string& value)
{
    std::string name = field;
    std::transform(name.begin(), name.end(), name.begin(), ::tolower);
    ...
    if (!value.empty()
        && (name == "account_from_id" || name == "account_from_cur" || name == "amount_from"))
    {
    ...
    if (!value.empty()
        && (name == "account_to_id" || name == "account_to_cur" || name == "amount_to"))
    {
...
void SetDocTypeValue(DocumentType& docType, const std::string& field, const std::string& value)
{
    std::string name = field;
    std::transform(name.begin(), name.end(), name.begin(), ::tolower);
...
void SetPaymentValue(PaymentDocument& doc, const std::string& field, const std::string& value)
{
    std::string name = field;
    std::transform(name.begin(), name.end(), name.begin(), ::tolower);
...
void SetPaymentsBalanceValue(hb::PaymentsBalanceRow& balance,
...
void SetPaymentTypeValue(hb::PaymentType& paymentType,
                         const std::string& field,
                         const std::string& value)
{
    std::string name = field;
